...
class OutputCSVSteppable(SteppableBasePy):
    ...
    def start(self): 
        ...
        self.shared_steppable_vars["caf_cd8t_dist"] = 0
        self.shared_steppable_vars["caf_divisions"] = 0
        self.shared_steppable_vars["caf_activation"] = 0
        ...
        with open(self.output_file_path, "w", newline="") as f:
            ...
            writer.writerow(["MCS",
                ...
                "CAF Count", "Local CAF Density", "Average CAF CD8 T Distance",
                "CAF Total Divisions", "CAF Mean Activation",
    ...
    def step(self, mcs):
        ...
        with open(self.output_file_path, "a", newline="") as f:
            ...
            writer.writerow([mcs, 
                ...
                caf_count, self.shared_steppable_vars["caf_density"], self.shared_steppable_vars["caf_cd8t_dist"],
                self.shared_steppable_vars["caf_divisions"], self.shared_steppable_vars["caf_activation"],
